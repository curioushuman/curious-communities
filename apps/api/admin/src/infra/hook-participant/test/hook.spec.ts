...
describe('ApiAdminStack : hook', () => {
  ...
  describe('/participants/{externalId}/{eventType}?{updatedStatus?}', () => {
    const resourceParentRegex = 'ccapiadminRestApiparticipantshook[A-Z0-9]+';
    const resourceIdRegex =
      'ccapiadminRestApiparticipantshookexternalIdeventType[A-Z0-9]+';
