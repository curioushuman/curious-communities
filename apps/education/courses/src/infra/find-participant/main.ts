...
import { FindParticipantRequestDto } from './dto/request.dto';
...
export const handler = async (
  requestDtoOrEvent:
    ...
    | EventBridgeEvent<'putEvent', FindParticipantRequestDto>
  ...
  if (!FindParticipantRequestDto.guard(requestDto)) {
  ...
  return findParticipantController.find({
    id: requestDto.id,
    idSourceValue: requestDto.idSourceValue,
  });
};
