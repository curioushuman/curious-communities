...
import { EdAppApiGroupMemberSourceRepository } from '../group-member-source.repository';
...
defineFeature(feature, (test) => {
  let repository: EdAppApiGroupMemberSourceRepository;
  ...
  beforeAll(async () => {
    ...
    ) as EdAppApiGroupMemberSourceRepository;

    // this is the simpler version
    // I know this ID exists, it'll do for now
    groupSourceId = '5f51c8ceae798f3ac21cc923' as GroupSourceId;
  });
  ...
  test('Successfully find one group member source by member id', ({
    ...
    and('a matching record exists at the source', async () => {
      // this is the simpler version
      // I know this ID exists, it'll do for now
      groupMemberSourceId = '5f18c98dc5e54200075d73f6' as MemberSourceId;
    });
