...
import { TribeApiHttpConfigService } from '../http-config.service';
...
defineFeature(feature, (test) => {
  let httpConfigService: TribeApiHttpConfigService;
  ...
  beforeAll(async () => {
    ...
    httpConfigService = moduleRef.get<TribeApiHttpConfigService>(
